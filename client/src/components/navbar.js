...
import {
  Drawer, AppBar, Toolbar, List, Typography, CssBaseline, IconButton, ListItem, ListItemIcon, ListItemText, Menu, MenuItem,
  Divider, Tooltip /*, InputBase*/
    ...
    >
      {
        users.map((user) => {
          if (user.uid === currentUser.uid) {
            return (<MenuItem onClick={handleMenuClose} key={user.uid}><Link to={'/profile'}>Profile</Link> </MenuItem>);
          }
    ...
    <div className={classes.navbarRoot}>
      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" style={{'color':"#3d3d3d"}} noWrap className={classes.titleText}>
          Student Education Platform
          </Typography>
