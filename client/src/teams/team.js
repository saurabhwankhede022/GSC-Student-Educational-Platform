...
import {
  AppBar, CssBaseline, Drawer, Hidden, List, Toolbar, IconButton, ListItem, Button, InputBase, ListItemIcon,
  ListItemText, Menu, MenuItem, Dialog, DialogActions, DialogContent, DialogTitle, Divider
      ...
      <List>
        ...
        </ListItem>
        {
          teams.map((team) => {
            ...
            return null; // or return <></>; to render nothing when the condition is not met
          })
        }
        ...
        <Toolbar>
          ...
          </IconButton>
          {
            teams.map((team) => {
              ...
              return null; // or return <></>; to render nothing for teams that don't meet the condition
            })
          }
