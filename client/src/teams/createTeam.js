...
const CreateTeam = () => {
    ...
    return (
        <div style={{ alignContent: 'center' }}>
            <Grid 
                container 
                style={{ marginTop: '10vh', marginLeft: '10vw', marginRight: '10vw', alignItems: 'center' }} 
            >
                {/* CREATE A TEAM */}
                <Grid 
                    item 
                    xs={12} lg={3} md={6} 
                    style={{ margin: '10vh 20vw', padding: '3vw', border: '1px solid #000000' }}
                >
                    <Typography 
                        variant="h5" 
                        align="left" 
                    ...
                    <form onSubmit={handleGenerateCode}>
                        ...
                        {teamCreated ? (
                            <Typography style={{ marginTop: '2%' }}>
                                Team successfully created! Your team code is: {code}
                            </Typography>
                        ) : (
                            <Button 
                                type="submit" 
