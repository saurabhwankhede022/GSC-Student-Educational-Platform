          ...
          <AppBar position='static' style={{backgroundColor: '#ffffff'}}>
            <Toolbar>
              <Typography variant='h6' style={{padding: '4%', fontWeight: 'bold', color: '#000000'}}>
                Developed by Saurabh Anil Wankhede
                <p>Follow me</p>
              </Typography>
              <IconButton style={{color: '#000000'}} href='https://www.linkedin.com/in/saurabhwankhede'><LinkedInIcon/></IconButton>
              <IconButton style={{color: '#000000'}} href='https://www.credly.com/users/saurabh-wankhede'><CloudIcon/></IconButton>
            </Toolbar>
          </AppBar>
