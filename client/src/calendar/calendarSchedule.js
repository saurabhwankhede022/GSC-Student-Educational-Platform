          ...
          <List className={classes.listRoot}>
            {
              meetings.map((meeting) => {
                if (meeting.time) {
                  return (
                    <ListItem key={meeting.id}> {/* Ensure you have a key here for each item */}
                      <ListItemAvatar>
                        <Avatar>
                          <EventIcon />
                        </Avatar>
                      ...
                      <div onClick={(e) => db.doc(`meetings/${meeting.code}/participants/${currentUser.uid}`)
                          .set({
                        ...
                        <Button 
                          ...
                          onClick={(e) => { 
                            e.stopPropagation(); // Prevents the event from reaching the parent div
                            history.push(`/room/${meeting.code}`);
                          }}>
                          Join
                        </Button>
                      </div>
                ...
                return null; // Return null for meetings without a defined time
              })
            }   
          </List>   
        </div>
